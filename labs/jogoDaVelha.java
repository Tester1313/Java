...
public class jogoDaVelha {
	...
	boolean verificarGanhador(char sinal) {
		if((jogoVelha[0][0]== sinal && jogoVelha[0][1]== sinal && jogoVelha[0][2]== sinal) || // Linha 1
				...
				(jogoVelha[1][0]== sinal && jogoVelha[1][1]== sinal && jogoVelha[1][2]== sinal) || //Coluna 2 
				(jogoVelha[2][0]== sinal && jogoVelha[2][1]== sinal && jogoVelha[2][2]== sinal) || //Coluna 3
				(jogoVelha[0][0]== sinal && jogoVelha[1][1]== sinal && jogoVelha[2][2]== sinal) || // Diagonal Principal
				(jogoVelha[0][2]== sinal && jogoVelha[1][1]== sinal && jogoVelha[2][0]== sinal) ) {// Diagonal Secundaria
			return true;
