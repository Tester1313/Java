	...
	public static void main(String[] args) {
		// Agenda de verificação de compromisso
				...
				while(!sair) {
					...
					if(acao == 1) {
						// Faço a verificacao do mes do evento
						verMes = false;
					...
					// Visualizo um novo evento
						...
						System.out.println("Seu evento no dia "+dia+" e horário "+hora+" é: "+compromissos[mes][dia][hora]);
					...
					// Edito um Evento
						...
						System.out.println("Seu evento nesse dia é : "+compromissos[mes][dia][hora]);
