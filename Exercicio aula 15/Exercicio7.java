...
public class Exercicio7 {
	...
	public static void main(String[] args) {
		// Le 3 valores e mostra o maior e o menor
		...
		if ( valor1 < valor2 && valor1 < valor3 ) {
			System.out.println("Valor1 é o menor dos três ");
		} else if ( valor2 < valor1 && valor2 < valor3) {
			System.out.println("Valor2 é o menor dos três ");
		} else {
			System.out.println("Valor3 é o menor dos três ");
		}
